(function () {
    ...
    function MarketController($routeParams, NeighborhoodService, $location, $sce, $http) {
        var vm = this;
        ...
        function init() {
            NeighborhoodService
                ...
                .then(function (result) {
                    ...
                    $location.url("/user/" + userId + "/market/" + place.street + "/" + place.city + "/" + place.state + "/" + vm.addressId);
                })
        }
        ...
        function checkSafeUrl4() {
            var url = "https://www.google.com/maps/embed/v1/search?key=AIzaSyD6TfeGbq0OZX86s45odgvXuaqhouSO8I0&q=" + "market near" + zipcode.num;
